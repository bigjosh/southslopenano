...
- **Home page:** `docs/index.html` → `https://southslopenano.com/` is a generic South Slope Nano Devices landing — one paragraph describing the company (nano-lithography arm of Gotham Silicon, Columbia Nano Initiative clean room, NYC), plus a card linking to the Mosaic campaign.
